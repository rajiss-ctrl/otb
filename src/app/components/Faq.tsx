    ...
    <section className="relative py-24 lg:py-[100px] bg-[#61004B] rounded-t-[40px] lg:rounded-t-[100px] text-white px-4 lg:px-[250px]">
      ...
      <div className="text-white py-4 lg:py-16 bg-white/5 backdrop-blur-xl">
        ...
        {faqData.map((item, index) => (
          <div 
            key={index} 
            className="border-b border-[#322130]"
          >
            <div className="relative">
              ...
              {/* Answer Content - Positioned absolutely */}
              <AnimatePresence initial={false}>
                {openIndex === index && (
                  <motion.div
                    ...
                    className="absolute left-0 right-0 z-10 bg-[#61004B] shadow-lg"
                  >
                    <div className="flex gap-4 lg:gap-6 p-4 lg:px-[40px] lg:pb-8">
                      ...
                      <p className="font-inter text-[#E6E6E6CC] text-[14px] lg:text-[18px] font-[400] leading-[150%] lg:leading-[100%]">
                        {item.answer}
                      </p>
                    </div>
                  </motion.div>
