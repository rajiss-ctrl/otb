...
const Hero = () => {
  return (
    <header className='bg-[url("/pattern.svg")] relative z-40 overflow-hidden bg-cover bg-center bg-no-repeat bg-[rgba(0,0,0,1)] h-[533px] lg:h-[690px] px-4 py-6 lg:px-[100px] lg:py-[33px]'>
        <Image src='/background_net.svg' fill alt='background' className='absolute z-0 inzet-10 object-contain'/>
        <Image src='/globe.svg' width={600} height={600} alt='background' className='spin-globe absolute top-[120px] -right-80 z-10 hidden lg:block '/>
        <Image src='/globe.svg' width={600} height={600} alt='background' className='spin-globe absolute top-[120px] -right-60 z-10 lg:hidden'/>
        <Navbar/>
        ...
        <Image src='/abstract _design.svg' width={800} height={800} alt='background' className='absolute z-20 top-1/2 right-1/2 translate-x-1/2 translate-y-1/2 hidden lg:block'/>
        <Image src='/abstract_design_mobile.svg' width={800} height={800} alt='background' className='absolute z-20 bottom-24 right-1/2 translate-x-1/2 translate-y-1/2 lg:hidden'/>
    </header>
  )
}
