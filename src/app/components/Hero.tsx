...
import Image from 'next/image'
  ...
  return (
    <header className='bg-[url("/pattern.svg")] relative z-20 overflow-hidden bg-cover bg-center bg-no-repeat bg-[rgba(0,0,0,1)] h-[533px] lg:h-[750px] px-4 py-6 lg:px-[100px] lg:py-[33px]'>
        <Image src='/pattern.svg' fill alt='background' className='absolute z-0 inzet-10 object-contain'/>
        <Image src='/globe.svg' width={800} height={800} alt='background' className='spin-globe absolute top-[120px] -right-96 z-0 hidden lg:block '/>
        ...
        <div className="relative text-[rgba(255,255,255,1)] z-50 mt-[110px] lg:w-[900px]">
          <div className="light_blue_floating absolute w-[80px] lg:w-[110px] h-[20px] lg:h-[30px] bg-[rgba(71,111,255,1)] rotate-[17.14deg] -left-3 -top-6 text-[5px] lg:text-[10px] pt-1 lg:pt-[6px] text-center pl-1 rounded-[20px]">Web Development</div>
          ...
          <div className="orange_floating absolute w-[80px] lg:w-[140px] h-[20px] lg:h-[30px] bg-[rgba(244,79,1,1)] rotate-[-17.14deg] right-6 lg:-right-16 bottom-[50%] lg:bottom-[25%] text-[5px] lg:text-[10px] pt-1 lg:pt-[6px] text-center pl-2 rounded-[20px]">Software Development</div>
          ...
          <p className='text-[18px] mt-[10px] leading-[110%] text-[rgba(255,255,255,0.6)] font-light lg:w-[700px]'>At OTB, we offer a unique and meticulous approach to web and app development, graphic design, custom solutions, software development and video editing</p>
        </div>
