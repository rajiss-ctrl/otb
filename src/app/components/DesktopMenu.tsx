    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            className="flex flex-col lg:flex-row justify-start lg:justify-between w-full lg:flex-grow lg:items-end mt-[44px] lg:mt-0 pb-[53px] lg:pb-0 relative z-50 px-2 lg:px-6"
            initial="hidden"
            animate="visible"
            variants={{
              hidden: { opacity: 0 },
          ...
          >
            {/* First Column */}
            <motion.ul className="space-y-[30px]">
            {[
                ...
                <Link href={item.href} className="flex items-end gap-4">
                    ...
                    <motion.span 
                    className={`${item.className} text-xl lg:text-[30px] font-[400] lg:font-[700] leading-[150%] ${pathname === item.href ? 'text-blue-500 font-bold' : 'text-white'}`}
            ...
            {/* Second Column */}
            <motion.ul className="space-y-[30px] my-[30px] lg:mt-0">
            {[
                ...
                <Link href={item.href} className="flex items-end gap-4">
                    ...
                    <p className={`${pathname === item.href ? 'text-blue-500 font-bold' : 'text-white'}`}>{item.icon}</p>
                    <motion.span 
                    className={`${item.className} text-xl lg:text-[30px] font-[400] lg:font-[700] leading-[100%] ${pathname === item.href ? 'text-blue-500 font-bold' : 'text-white'}`}
                    onClick={item.onClick}
                    >
                    {item.text}
                    </motion.span>
            ...
            {/* Social for mobile */}
            <motion.div
              className="flex lg:hidden flex-col w-[247px] mb-[32px] gap-[20px] rounded-[12px] border border-[#262626] pl-[24px] pr-[4px] py-[14px]"
              variants={itemVariants}
              transition={transition}
            >
            ...
            {/* Third Column */}
            <motion.ul className="space-y-[18px] lg:space-y-[36px]">
              {[
                { text: "Get in touch", className: "ml-24 text-[22px] text-[#FFFFFFB2]" },
                { 
                  content: (
                    <>
                  ...
                  className: "w-[247px] lg:w-auto border-b pb-4 border-[#262626] lg:ml-24 flex gap-1 items-center text-[18px] text-[#FDFDFD]"
                },
                { 
                  content: (
                    <>
              ...
              {/* Social for desktop */}
              <motion.div
                className="hidden lg:flex flex-col lg:flex-row items-center gap-[20px] rounded-[12px] border border-[#262626] pl-[24px] pr-[4px] py-[14px]"
                variants={itemVariants}
                transition={transition}
              >
                <motion.span variants={itemVariants} transition={transition}>
