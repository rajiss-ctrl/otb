...
const Footer = () => {
  return (
    <footer className='bg-[#000000] relative lg:pl-[30px] xl:pl-[120.12px] lg:pr-[30px] xl:pr-[100px] border-t border-[#262626] text-white'>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center py-3 border-b  border-[#262626]">
            <Link href={'/'}>
                <Image src='/Over the Board Logo2.svg' width={500} height={500} alt="otb" className='lg:-ml- xl:-ml-16 hidden lg:block'/>
                <Image src='/Over the Board Logo2.svg' width={400} height={400} alt="otb" className='lg:hidden'/>
            </Link>
            <div className="flex flex-col lg:flex-row items-center -mt-8 lg:-mt-0 lg:gap-[25px] xl:gap-[96px]">
            <ul className='flex flex-col gap-4 lg:gap-[30px] text-[18px] font-[400] leading-[100%]  lg:flex-row items-center'>
                <li className='font-inter xl:text-[18px] font-[400] mb-[11.5px] lg:mb-0'><Link href={'/'}>Home</Link></li>
                <li className='font-inter xl:text-[18px] font-[400] mb-[11.5px] lg:mb-0'><Link href={'/'}>Services</Link></li>
                <li className='font-inter xl:text-[18px] font-[400] mb-[11.5px] lg:mb-0'><Link href={'/projects'}>Projects</Link></li>
                <li className='font-inter xl:text-[18px] font-[400] mb-[11.5px] lg:mb-0'><Link href={'/'}>About</Link></li>
                <li className='font-inter xl:text-[18px] font-[400] mb-[11.5px] lg:mb-0'><Link href={'/'}>Contact</Link></li>
            </ul>
        ...
        <div className="flex flex-col lg items-center pt-[38px] pb-[50px] lg:pb-[111px] ">
            <div className="w-full flex flex-col lg:flex-row justify-between items-center">
                <div className="flex items-center gap-[4px]  border-b pt-3 lg:pb-1 border-[#262626]">
                ...
                <div className="flex items-center gap-1 lg:gap-[4px] px-[2rem] lg:px-0 text-center lg:text-start border-b pt-3 lg:pb-1 border-[#262626]">
                    <Image src='/address.png' width={20} height={24} alt="otb" className='hidden lg:block p-[1px]'/>
                    <Image src='/address.png' width={40} height={40} alt="otb" className='lg:hidden p-2'/>
