...
const ValueProposition = () => {
  return (
    <section className='bg-[#060606] flex flex-col justify-center items-center pb-[102px] px-[16px] text-white lg:px-[100px]'>
        <h1 className='font-bricolage my-[80px] text-[20px] lg:text-[60px] leading-[100%] font-bold'>Why Choose Us?</h1>
        <div className="">
            <div className="flex flex-col lg:flex-row items-center border-t lg:border-b border-gray-900">
                <div className="lg:border-r lg:border-gray-900 p-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className='font-bricolage text-[28px] font-[600] leading-[100%] '>Experience and Expertise</h3>
                    </div>
                ...
                <div className=" p-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className='font-bricolage text-[28px] font-[600] leading-[100%] '>Creative Innovation</h3>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row items-center">
                <div className="lg:border-r border-gray-900 p-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className='font-bricolage text-[28px] font-[600] leading-[100%] '>Quality Assurance</h3>
                    </div>
                ...
                <div className=" p-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className='font-bricolage text-[28px] font-[600] leading-[100%] '>Client-Centric Approach</h3>
                    </div>
