...
const Projects = () => {
  return (
    <section className='relative'>
        ...
        <div className='bg-[#262626] flex items-center rounded-[4.69px] lg:rounded-[20px] lg:pb-[40px] relative '>
            ...
            <div className=" flex flex-col justify-between">
                <div className="pl-4 lg:pl-[43px] lg:mb-[100px]">
                    ...
                    <div className="flex items-center gap-[12px]">
                        ...
                        <p className='text-[#E6E6E6] text-[6px] lg:text-[16px] leading-[150%] lg:leading-[100%]'>October 2024 - December 2024</p>
                    </div>
                </div>
