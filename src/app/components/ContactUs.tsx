...
const ContactUs = () => {
  return (
    <section className='px-4 py-8 lg:py-[118px] lg:px-[100px] text-white'>
        <div className="flex flex-col lg:flex-row">
            <div className="flex flex-col justify-between">
                <div className="">
                    <h4 className='text-[50px] font-[700] leading-[100%] lg:mb-[21px]'>Contact us</h4>
                    <p className='text-[20px] text-[#FFFFFFA8] font-[400] leading-[100%]'>Prepared to boost your IT systems to the next level? Leverage the unmatched knowledge of experts who effortlessly advance your operations. Together, we’ll optimize your tech capabilities. Seize this chance today!</p>
                </div>
                <Image src="/tiles.svg" width={300} height={300} alt=""/>
            </div>
            <form className="border border-[#262626] py-[16.12px] px-[52px] lg:p-[50px]">
                <div className="flex gap-[30px] pb-[30px]">
                    <div className="bg-[#262626] py-[22px] px-[40px] rounded-[8px]">
                        <p className='text-[22px] font-[600] leading-[100%]'>Full Name</p>
                    ...
                    <div className="bg-[#262626] lg:py-[22px] lg:px-[40px] rounded-[8px]">
                        <p className='text-[22px] font-[600] leading-[100%]'>Email</p>
                ...
                <div className="bg-[#262626] p-[40px] mb-[30px] rounded-[8px]">
                    <h4 className='text-[22px] font-[600] leading-[100%]'>Why are you contacting us?</h4>
                ...
                <div className="bg-[#262626] p-[40px] mb-[30px] rounded-[8px]">
                    <h4 className='mb-[20px] text-[22px] font-[600] leading-[100%]'>Your Message</h4>
